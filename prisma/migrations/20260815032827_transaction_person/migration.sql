...
INSERT INTO "new_Transaction" ("amount", "categoryId", "createdAt", "currency", "date", "debtId", "debtPaymentId", "fee", "id", "kind", "nature", "note", "originalAmount", "projectId", "rate") SELECT "amount", "categoryId", "createdAt", "currency", "date", "debtId", "debtPaymentId", "fee", "id", "kind", "nature", "note", "originalAmount", "projectId", "rate" FROM "Transaction";
